...
Usage:
    ...
    python apps/cli/demo.py --model_path models/lingbot-map-long.pt --image_folder example/courthouse
    ...
    # From video
    python apps/cli/demo.py --model_path models/lingbot-map-long.pt --video_path video.mp4 --fps 10
"""
...
from lingbot_map.inference import load_model as _load_model_lib, postprocess, prepare_for_visualization
...
def _load_model_from_args(args, device):
    """Thin wrapper: extract kwargs from argparse namespace → library call."""
...
# postprocess / prepare_for_visualization — imported from lingbot_map.inference
...
def main():
    ...
    model = _load_model_from_args(args, device)
